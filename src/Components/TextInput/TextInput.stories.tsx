...
export default {
    ...
    component: TextInput,
    argTypes: {
        label: { table: { category: 'Label Props' } },
        labelAttributes: { table: { category: 'Label Props' } },
        componentID: { table: { category: 'Input Props' } },
        value: {
            table: { category: 'Input Props' },
            control: 'text',
        },
        placeholder: { table: { category: 'Input Props' } },
        onChangeCallback: { table: { category: 'Input Props' } },
        inputAttributes: { table: { category: 'Input Props' } },
