...
var TextInput = function TextInput(_ref) {
  ...
  if (validate === true) {
    var _useState = useState(!validateInput(inputValue)),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    htmlFor: inputID
  }, labelAttributes), label), /*#__PURE__*/React.createElement("input", _extends({
    type: "text",
    id: inputID,
  ...
  })), errorExist === true && /*#__PURE__*/React.createElement("p", _extends({
...
var RadioSelect = function RadioSelect(_ref) {
  ...
  var _useState = useState(optionSelected || returnValueOfOptionSelected(options) || undefined),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var renderOptions = function renderOptions(options) {
    ...
    options.map(function (option, index) {
      optionArray.push( /*#__PURE__*/React.createElement("p", {
